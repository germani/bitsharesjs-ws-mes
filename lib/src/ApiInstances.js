...
class MesApis {
    ...
    */
    ...
    static network = new Proxy(MesApis, {
        get(apis, method) {
            return function() {
    ...
    static history = new Proxy(MesApis, {
        get(apis, method) {
            return function() {
    ...
    static crypto = new Proxy(MesApis, {
        get(apis, method) {
            return function() {
    ...
    static orders = new Proxy(MesApis, {
        get(apis, method) {
            return function() {
